...
//? eval() bir fonksiyon olsa da , birden çok işlem yaptırmamız gereken projelerde kolaylık sağlar.string ifade kullanarak yapmak istediğimiz işlemi algılar ve sonucunu yazdırır. 
let value = eval('1+1');
alert(value); // 2
